...
// def_ukernel_avx512!(1, step_3, acc_3, store_3, 3, 8, B, B, C, ukernel_bbc);
    ...
    (7, $nr:tt, 2, $c_macro:tt) => {
        seq!(n in 0..$nr {
            ...
            concat!(
                ...
                "lea ({x3}, {x4}, 1), {x4}", "\n",
                #(
                    "vfmadd231ps ", c_mem_dot!(0), ", %xmm0, %xmm", $c_macro!(0,n), "\n",
                    "vfmadd231ps ", c_mem_dot!(1), ", %xmm0, %xmm", $c_macro!(1,n), "\n",
                    "vfmadd231ps ", c_mem_dot!(2), ", %xmm0, %xmm", $c_macro!(2,n), "\n",
                    "vfmadd231ps ", c_mem_dot!(3), ", %xmm0, %xmm", $c_macro!(3,n), "\n",
                    "vfmadd231ps ", c_mem_dot!(4), ", %xmm0, %xmm", $c_macro!(4,n), "\n",
                    "vfmadd231ps ", c_mem_dot!(5), ", %xmm0, %xmm", $c_macro!(5,n), "\n",
                    "vfmadd231ps ", c_mem_dot!(6), ", %xmm0, %xmm", $c_macro!(6,n), "\n",
                    "add {x1},{x2} \n add {x1},{x3} \n add {x1},{x4} \n",
                )*
            )
        })
