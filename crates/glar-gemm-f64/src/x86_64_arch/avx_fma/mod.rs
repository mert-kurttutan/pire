...
def_kernel_bb_pf1!(f64, f64, f64, f64, f64, F, 3, 4, 96, 4);

use glar_base::def_kernel_bs;

def_kernel_bs!(f64, f64, f64, f64, f64, 3, 4, 3, 2, 1);
...
def_kernel_sb_v0!(TA, TB, TC, TA, TC, F, packa_panel_12, 1, 3, 4);
...
pub(crate) unsafe fn kernel_12x4<F: UnaryFnC>(
    m: usize,
    n: usize,
    k: usize,
    alpha: *const TA,
