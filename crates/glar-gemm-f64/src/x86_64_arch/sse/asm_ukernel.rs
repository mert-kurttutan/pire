...
macro_rules! acc_4x4 {
    ($ni:tt, $layout:tt) => {
        acc_p!($layout, c_mem!($ni), c_reg_4x4!(0,$ni), c_reg_4x4!(1,$ni))
    };
}

macro_rules! store_4x4 {
    ($ni:tt, $layout:tt) => {
        storep!($layout, c_mem!($ni), c_reg_4x4!(0,$ni), c_reg_4x4!(1,$ni))
    };
}

macro_rules! acc_2x4 {
    ($ni:tt, $layout:tt) => {
        acc_p!($layout, c_mem!($ni), c_reg_2x4!(0,$ni))
    };
}

macro_rules! store_2x4 {
    ($ni:tt, $layout:tt) => {
        storep!($layout, c_mem!($ni), c_reg_2x4!(0,$ni))
    };
}
...
def_ukernel!(step_4x4, acc_4x4, store_4x4, 4, 4, B, B, C, ukernel_4x4_bb);
// def_ukernel!(step_2x4, acc_2x4, store_2x4, 2, 4, B, B, C, ukernel_16x8_bb);

def_ukernel!(step_4x4, acc_4x4, store_4x4, 4, 4, B, B, C, ukernel_4x4_bb_partial);
def_ukernel!(step_2x4, acc_2x4, store_2x4, 2, 4, B, B, C, ukernel_2x4_bb_partial);

def_ukernel!(step_4x4, acc_4x4, store_4x4, 4, 4, B, S, C, ukernel_4x4_bs);

def_ukernel!(step_4x4, acc_4x4, store_4x4, 4, 4, B, S, C, ukernel_4x4_bs_partial);
def_ukernel!(step_2x4, acc_2x4, store_2x4, 2, 4, B, S, C, ukernel_2x4_bs_partial);


def_ukernelxn!(step_4x4, acc_4x4, store_4x4, 4, 4, B, B, C, ukernel_4xn_bb);
// def_ukernelxn!(asm_16x6_step, asm_16x6_acc, asm_16x6_store, 4, 4, B, B, C, ukernel_16xn_bb);
// def_ukernelxn!(step_2x4, acc_2x4, store_2x4, 2, 4, B, B, C, ukernel_16xn_bb);

def_ukernelxn!(step_4x4, acc_4x4, store_4x4, 4, 4, B, B, C, ukernel_4xn_bb_partial);
def_ukernelxn!(step_2x4, acc_2x4, store_2x4, 2, 4, B, B, C, ukernel_2xn_bb_partial);

def_ukernelxn!(step_4x4, acc_4x4, store_4x4, 4, 4, B, S, C, ukernel_4xn_bs);

def_ukernelxn!(step_4x4, acc_4x4, store_4x4, 4, 4, B, S, C, ukernel_4xn_bs_partial);
def_ukernelxn!(step_2x4, acc_2x4, store_2x4, 2, 4, B, S, C, ukernel_2xn_bs_partial);
