        ...
        paste! {
            ...
            pub unsafe fn kernel_bb<F: MyFn, const STRIDED: bool>(
                ...
                while m_iter > 0 {
                    ...
                    while n_iter > 0 {
                        let a_pft1_offset = ($MR+(n_iter0-n_iter)*2)*8*k;
        ...
        paste! {
            ...
            pub unsafe fn kernel_sb_v0<F: MyFn, const STRIDED: bool>(
                ...
                while m_iter > 0 {
                    ...
                    let mut b_cur = b;
                    let mut c_cur1 = c_cur0;
                    packa_panel_24(MR, k, a_cur, a_rs, a_cs, ap_cur, VS);
                    while n_iter > 0 {
                        let a_pft1_offset = ($MR+(n_iter0-n_iter)*2)*4*k;
                ...
                $(
                    if (m_left+VS-1) / VS *VS == $mr_left {
                        packa_panel_24(m_left, k, a_cur, a_rs, a_cs, ap_cur, VS);
                        let mut n_iter = n_iter0;
                        let mut b_cur = b;
                        let mut c_cur1 = c_cur0;
                        while n_iter > 0 {
