...
unsafe fn kernel_m<F: MyFn>(
    ...
    if kc_last {
        match hw_cfg.reg_dim {
            ...
            RegDim::Reg8x3 => avx_fma::kernel_8x3_bs(
                m,
                n,
                k,
                alpha,
        ...
        match hw_cfg.reg_dim {
            ...
            RegDim::Reg8x3 => {
                avx_fma::kernel_8x3_bs(m, n, k, alpha, b, b_rs, b_cs, c, c_rs, c_cs, ap, null_fn)
            }
            RegDim::Reg8x2 => {
...
unsafe fn kernel_n<F: MyFn>(
    ...
    if kc_last {
        match hw_cfg.reg_dim {
            ...
            RegDim::Reg8x3 => avx_fma::kernel_8x3_sb(
                m,
                n,
                k,
                alpha,
        ...
        match hw_cfg.reg_dim {
            ...
            RegDim::Reg8x3 => {
                avx_fma::kernel_8x3_sb(m, n, k, alpha, a, a_rs, a_cs, b, c, c_rs, c_cs, ap, null_fn)
            }
            RegDim::Reg8x2 => {
...
unsafe fn glare_gemv<F: MyFn>(
    ...
    match hw_cfg.reg_dim {
        RegDim::Reg16x7 | RegDim::Reg8x3 => avx_fma::axpy(
            m,
            n,
            alpha,
            a.data_ptr(),
