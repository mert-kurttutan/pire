...
use glare_base::{
    ap_size, bp_size, get_cache_params, has_f32_compute, Array, ArrayMut, GemmCache, GlarePar,
...
mod tests {
    use super::*;
    use glare_dev::{
        check_gemm_c32, generate_k_dims, generate_m_dims, generate_n_dims, layout_to_strides,
