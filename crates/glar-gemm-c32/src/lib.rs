...
use glar_base::{
    ap_size, bp_size, has_c32_compute, Array, ArrayMut, GemmCache, GlarPar, IdentityFn, UnaryFn, RUNTIME_HW_CONFIG,
};

pub(crate) trait UnaryFnC: UnaryFn<TC> {}
impl<F: UnaryFn<TC>> UnaryFnC for F {}

pub(crate) unsafe fn glar_cgemm_generic<F: UnaryFnC>(
    m: usize,
    n: usize,
    k: usize,
    alpha: TA,
