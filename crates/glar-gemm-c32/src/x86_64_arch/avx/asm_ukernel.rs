...
def_ukernel!(step_2x2, acc_2x2, store_2x2, 8, 2, B, B, C, ukernel_2x2_bb);
// def_ukernel!(step_1x2, acc_1x2, store_1x2, 8, 4, B, B, C, 4, ukernel_16x8_bb);


def_ukernel!(step_2x2, acc_2x2, store_2x2, 8, 2, B, B, M, ukernel_2x2_bb_partial);
def_ukernel!(step_1x2, acc_1x2, store_1x2, 4, 2, B, B, M, ukernel_1x2_bb_partial);

def_ukernel!(step_2x2, acc_2x2, store_2x2, 8, 2, B, S, C, ukernel_2x2_bs);


def_ukernel!(step_2x2, acc_2x2, store_2x2, 8, 2, B, S, M, ukernel_2x2_bs_partial);
def_ukernel!(step_1x2, acc_1x2, store_1x2, 4, 2, B, S, M, ukernel_1x2_bs_partial);

def_ukernelxn!(step_2x2, acc_2x2, store_2x2, 8, 2, B, B, C, ukernel_2xn_bb);
// def_ukernelxn!(step_1x2, acc_1x2, store_1x2, 8, 4, B, B, C, 4, ukernel_2xn_bb);

def_ukernelxn!(step_2x2, acc_2x2, store_2x2, 8, 2, B, B, M, ukernel_2xn_bb_partial);
def_ukernelxn!(step_1x2, acc_1x2, store_1x2, 4, 2, B, B, M, ukernel_1xn_bb_partial);

def_ukernelxn!(step_2x2, acc_2x2, store_2x2, 8, 2, B, S, C, ukernel_2xn_bs);

def_ukernelxn!(step_2x2, acc_2x2, store_2x2, 8, 2, B, S, M, ukernel_2xn_bs_partial);
def_ukernelxn!(step_1x2, acc_1x2, store_1x2, 4, 2, B, S, M, ukernel_1xn_bs_partial);
