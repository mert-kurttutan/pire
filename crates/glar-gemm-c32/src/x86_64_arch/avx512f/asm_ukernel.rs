...
use crate::UnaryFnC;
use glar_base::{load_buf, store_buf, c_mem, def_ukernel_alpha_beta, def_ukernelxn_alpha_beta};
...
macro_rules! alternating_array {
    ($var:ident) => {
        let $var = [-1.0f32, 1.0f32];
    };
}


def_ukernel_alpha_beta!(step_3x4, acc_3x4, store_3x4, 24, 4, B, B, M, ukernel_3_bb_partial);
def_ukernel_alpha_beta!(step_2x6, acc_2x6, store_2x6, 16, 4, B, B, M, ukernel_2_bb_partial);
def_ukernel_alpha_beta!(step_1x6, acc_1x6, store_1x6, 8, 4, B, B, M, ukernel_1_bb_partial);

def_ukernel_alpha_beta!(step_3x4, acc_3x4, store_3x4, 24, 4, B, S, C, ukernel_bs);

def_ukernel_alpha_beta!(step_3x4, acc_3x4, store_3x4, 24, 4, B, S, M, ukernel_3_bs_partial);
def_ukernel_alpha_beta!(step_2x6, acc_2x6, store_2x6, 16, 4, B, S, M, ukernel_2_bs_partial);
def_ukernel_alpha_beta!(step_1x6, acc_1x6, store_1x6, 8, 4, B, S, M, ukernel_1_bs_partial);


def_ukernelxn_alpha_beta!(step_3x4, acc_3x4, store_3x4, 24, 4, B, B, C, ukernel_n_bb);

def_ukernelxn_alpha_beta!(step_3x4, acc_3x4, store_3x4, 24, 4, B, B, M, ukernel_3xn_bb_partial);
def_ukernelxn_alpha_beta!(step_2x6, acc_2x6, store_2x6, 16, 6, B, B, M, ukernel_2xn_bb_partial);
def_ukernelxn_alpha_beta!(step_1x6, acc_1x6, store_1x6, 8, 6, B, B, M, ukernel_1xn_bb_partial);

def_ukernelxn_alpha_beta!(step_3x4, acc_3x4, store_3x4, 24, 4, B, S, C, ukernel_n_bs);

def_ukernelxn_alpha_beta!(step_3x4, acc_3x4, store_3x4, 24, 4, B, S, M, ukernel_3xn_bs_partial);
def_ukernelxn_alpha_beta!(step_2x6, acc_2x6, store_2x6, 16, 4, B, S, M, ukernel_2xn_bs_partial);
def_ukernelxn_alpha_beta!(step_1x6, acc_1x6, store_1x6, 8, 4, B, S, M, ukernel_1xn_bs_partial);
