    ...
    (
        ...
        pub(crate) unsafe fn $func_name<F: MyFn, const BUF: bool>(
            ...
            asm!(
                ...
                m_e2 = in(reg) (2*m - (2*vs).min(2*m)) as u64,
                x0 = out(reg) _,
                x1 = out(reg) _,
                x2 = out(reg) _,
                x3 = out(reg) _,
...
def_ukernel!(step_3x8, acc_3x8, store_3x8, 6, 8, B, B, M, ukernel_3x8_bb_partial);


def_ukernelxn!(step_3x8, acc_3x8, store_3x8, 6, 8, B, B, C, ukernel_3xn_bb);

def_ukernelxn!(step_3x8, acc_3x8, store_3x8, 6, 8, B, B, M, ukernel_3xn_bb_partial);
