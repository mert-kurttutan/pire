...
pub(crate) unsafe fn packa_fn(x: *const TA, y: *mut TA, m: usize, k: usize, rs: usize, cs: usize) {
    ...
    if hw_config.cpu_ft.avx512f {
        pack_avx::packa_panel_12(m, k, x, rs, cs, y, 4);
    } else if hw_config.cpu_ft.avx && hw_config.cpu_ft.fma {
        pack_avx::packa_panel_6(m, k, x, rs, cs, y, 2);
    } else if hw_config.cpu_ft.avx {
        pack_avx::packa_panel_4(m, k, x, rs, cs, y, 2);
    } else {
        pack_sse::packa_panel_2(m, k, x, rs, cs, y, 1);
    }
}
...
impl<F: UnaryFnC> KernelDispatcher<F> {
    ...
    //         RegDim::Reg6x2 => pack_avx::packa_panel_6(m, k, x, rs, cs, y, self.vs),
    //         RegDim::Reg4x2 => pack_avx::packa_panel_4(m, k, x, rs, cs, y, self.vs),
    ...
    //     match self.reg_dim {
    //         RegDim::Reg12x4 => pack_avx::packb_panel_4(n, k, x, cs, rs, y),
    //         RegDim::Reg6x2 => pack_avx::packb_panel_2(n, k, x, cs, rs, y),
