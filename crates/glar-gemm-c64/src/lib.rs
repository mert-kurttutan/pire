...
use glar_base::{
    get_cache_params, has_c64_compute, Array, ArrayMut, GemmCache, GlarPar, IdentityFn, UnaryFn, AB_ALIGN,
};
...
pub unsafe fn packa_c64_unchecked(
    m: usize,
    k: usize,
    a: *const TA,
    a_rs: usize,
...
pub unsafe fn packb_c64_unchecked(
    n: usize,
    k: usize,
    b: *const TB,
    b_rs: usize,
...
pub unsafe fn packa_c64_with_ref(m: usize, k: usize, a: &[TA], a_rs: usize, a_cs: usize, ap: &mut [TA]) -> Array<TA> {
    ...
    unsafe { packa_c64_unchecked(m, k, a.as_ptr(), a_rs, a_cs, ap_ptr_o as *mut TA) }
}
...
pub unsafe fn packb_c64_with_ref(n: usize, k: usize, b: &[TB], b_rs: usize, b_cs: usize, bp: &mut [TB]) -> Array<TB> {
    ...
    unsafe { packb_c64_unchecked(n, k, b.as_ptr(), b_rs, b_cs, bp_ptr_o as *mut TB) }
}
