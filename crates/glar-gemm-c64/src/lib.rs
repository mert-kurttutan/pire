...
use glar_base::{
    ap_size, bp_size, get_cache_params, has_f64_compute, Array, ArrayMut, GemmCache, GlarPar, HWModel,
    RUNTIME_HW_CONFIG,
};
...
fn get_mcnckc() -> (usize, usize, usize) {
    ...
    let (mc, nc, kc) = match (*RUNTIME_HW_CONFIG).hw_model {
        ...
        HWModel::Broadwell => (1200, 192, 192),
...
pub(crate) unsafe fn glar_zgemm_generic<F: MyFn>(
    m: usize,
    n: usize,
    k: usize,
    alpha: TA,
...
pub unsafe fn glar_sgemv(
    ...
    glar_zgemm(m, 1, n, alpha, a, a_rs, a_cs, x, 1, incx, beta, y, 1, incy)
}
pub unsafe fn glar_sdot(
    n: usize,
    alpha: TA,
    x: *const TA,
    incx: usize,
    ...
    glar_zgemm(1, 1, n, alpha, x, incx, 1, y, incy, 1, beta, res, 1, 1)
}
