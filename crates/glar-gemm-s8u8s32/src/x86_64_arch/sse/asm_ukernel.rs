...
def_ukernel_int_avx!(4, step_2x4, acc_2x4, store_2x4, 8, 4, B, B, C, ukernel_2_bb_partial);
def_ukernel_int_avx!(4, step_1x4, acc_1x4, store_1x4, 4, 4, B, B, C, ukernel_1_bb_partial);


def_ukernelxn_int_avx!(4, step_2x4, acc_2x4, store_2x4, 8, 4, B, B, C, ukernel_n_bb);

def_ukernelxn_int_avx!(4, step_2x4, acc_2x4, store_2x4, 8, 4, B, B, C, ukernel_2xn_bb_partial);
def_ukernelxn_int_avx!(4, step_1x4, acc_1x4, store_1x4, 4, 4, B, B, C, ukernel_1xn_bb_partial);
