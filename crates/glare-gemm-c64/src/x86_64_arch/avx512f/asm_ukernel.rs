...
macro_rules! acc_8x7 {
    ($ni:tt, $layout:tt) => {
        acc_p!($layout, c_mem!($ni), c_reg_8x7!(0,$ni), c_reg_8x7!(1,$ni))
    };
}

macro_rules! store_8x7 {
    ($ni:tt, $layout:tt) => {
        storep!($layout, c_mem!($ni), c_reg_8x7!(0,$ni), c_reg_8x7!(1,$ni))
    };
}

macro_rules! acc_4x7 {
    ($ni:tt, $layout:tt) => {
        acc_p!($layout, c_mem!($ni), c_reg_4x7!(0,$ni))
    };
}

macro_rules! store_4x7 {
    ($ni:tt, $layout:tt) => {
        storep!($layout, c_mem!($ni), c_reg_4x7!(0,$ni))
    };
}
