...
macro_rules! asm_alpha_scale {
	(VER2, 4) => {asm_alpha_scale_0!(4,11)};
	(VER2, 3) => {asm_alpha_scale_0!(4,9)};
	(VER2, 2) => {asm_alpha_scale_0!(4,7)};
	(VER2, 1) => {asm_alpha_scale_0!(4,5)};

	(VER1, 4) => {asm_alpha_scale_0!(5,8)};
	(VER1, 3) => {asm_alpha_scale_0!(5,7)};
	(VER1, 2) => {asm_alpha_scale_0!(5,6)};
	(VER1, 1) => {asm_alpha_scale_0!(5,5)};
}
