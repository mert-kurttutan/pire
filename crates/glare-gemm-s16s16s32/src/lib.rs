...
use glare_base::{
    ap_size_int, bp_size_int, get_cache_params, has_i16i32_compute, Array, ArrayMut, GemmCache,
...
pub(crate) unsafe fn glare_gemm_s16s16s32_generic<F: MyFn>(
    m: usize,
    n: usize,
    k: usize,
    alpha: f32,
...
pub unsafe fn glare_gemv_s16s16s32(
    ...
    glare_gemm_s16s16s32(m, 1, n, alpha, a, a_rs, a_cs, x, 1, incx, beta, y, 1, incy)
}
pub unsafe fn glare_dot_s16s16s32(
    ...
    glare_gemm_s16s16s32(1, 1, n, alpha, x, incx, 1, y, incy, 1, beta, res, 1, 1)
}
...
pub unsafe fn packa_i16_with_ref(
    m: usize,
    k: usize,
    a: &[TA],
    a_rs: usize,
...
pub unsafe fn packb_i16_with_ref(
    n: usize,
    k: usize,
    b: &[TB],
    b_rs: usize,
