...
macro_rules! vfmadd {
    ($i:tt, $j:tt, $b_macro:tt) => {
        concat!(
            "fcmla z", cr!($i,$j), ".d", ", p0/m, z", $i,".d, ", $b_macro!($j), ", #0 \n",
            "fcmla z", cr!($i,$j), ".d", ", p0/m, z", $i,".d, ", $b_macro!($j), ", #90 \n",
        )
    };
}
...
macro_rules! load_b {
    ...
    (B, 2, $b_macro:tt) => {
        concat!(
            "ld1rqd {{ z5.d }}, p0/z, [{bx}, #0x20]", "\n",
        )
    };
    (B, 3, $b_macro:tt) => {
        concat!(
            "ld1rqd {{ z6.d }}, p0/z, [{bx}, #0x30]", "\n",
        )
    };
    (B, 4, $b_macro:tt) => {
        concat!(
            "ld1rqd {{ z7.d }}, p0/z, [{bx}, #0x40]", "\n",
        )
    };
    (B, 5, $b_macro:tt) => {
        concat!(
            "ld1rqd {{ z3.d }}, p0/z, [{bx}, #0x50]", "\n",
        )
    };
    (B, 6, $b_macro:tt) => {
        concat!(
            "ld1rqd {{ z4.d }}, p0/z, [{bx}, #0x60]", "\n",
        )
    };
    (B, 7, $b_macro:tt) => {
        concat!(
            "ld1rqd {{ z5.d }}, p0/z, [{bx}, #0x70]", "\n",
        )
    };
}
