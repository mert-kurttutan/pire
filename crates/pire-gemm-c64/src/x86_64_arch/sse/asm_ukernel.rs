...
def_ukernel_sse!(1, step_2x2, acc_2x2, store_2x2, 2, 2, S, C, ukernel_bsc);


def_ukernel_sse!(1, step_2x2, acc_2x2, store_2x2, 2, 2, S, C, ukernel_2_bsp);
def_ukernel_sse!(1, step_1x2, acc_1x2, store_1x2, 1, 2, S, C, ukernel_1_bsp);
