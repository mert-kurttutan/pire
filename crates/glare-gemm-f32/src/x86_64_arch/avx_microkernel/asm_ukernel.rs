...
def_ukernel!(VER2, asm_16x4_step, asm_16x4_acc, asm_16x4_store, 16, 4, B, B, C, 0, 128, 4, ukernel_16x4_bb);
// def_ukernel!(VER1, asm_8x4_step, asm_8x4_acc, asm_8x4_store, 8, 4, B, B, C, 0, 128, 4, ukernel_16x8_bb);

def_ukernel!(VER2, asm_16x4_step, asm_16x4_acc, asm_16x4_store, 16, 4, B, B, M, 0, 128, 4, ukernel_16x4_bb_partial);
def_ukernel!(VER1, asm_8x4_step, asm_8x4_acc, asm_8x4_store, 8, 4, B, B, M, 0, 128, 4, ukernel_8x4_bb_partial);

def_ukernel!(VER2, asm_16x4_step, asm_16x4_acc, asm_16x4_store, 16, 4, B, S, C, 0, 128, 4, ukernel_16x4_bs);

def_ukernel!(VER2, asm_16x4_step, asm_16x4_acc, asm_16x4_store, 16, 4, B, S, M, 0, 128, 4, ukernel_16x4_bs_partial);
def_ukernel!(VER1, asm_8x4_step, asm_8x4_acc, asm_8x4_store, 8, 4, B, S, M, 0, 128, 4, ukernel_8x4_bs_partial);


def_ukernelxn!(VER2, asm_16x4_step, asm_16x4_acc, asm_16x4_store, 16, 4, B, B, C, 0, 128, 4, ukernel_16xn_bb);
// def_ukernelxn!(VER2, asm_16x6_step, asm_16x6_acc, asm_16x6_store, 16, 4, B, B, C, 0, 128, 4, ukernel_16xn_bb);
// def_ukernelxn!(VER1, asm_8x4_step, asm_8x4_acc, asm_8x4_store, 8, 4, B, B, C, 0, 128, 4, ukernel_16xn_bb);

def_ukernelxn!(VER2, asm_16x4_step, asm_16x4_acc, asm_16x4_store, 16, 4, B, B, M, 0, 128, 4, ukernel_16xn_bb_partial);
def_ukernelxn!(VER1, asm_8x4_step, asm_8x4_acc, asm_8x4_store, 8, 4, B, B, M, 0, 128, 4, ukernel_8xn_bb_partial);

def_ukernelxn!(VER2, asm_16x4_step, asm_16x4_acc, asm_16x4_store, 16, 4, B, S, C, 0, 128, 4, ukernel_16xn_bs);

def_ukernelxn!(VER2, asm_16x4_step, asm_16x4_acc, asm_16x4_store, 16, 4, B, S, M, 0, 128, 4, ukernel_16xn_bs_partial);
def_ukernelxn!(VER1, asm_8x4_step, asm_8x4_acc, asm_8x4_store, 8, 4, B, S, M, 0, 128, 4, ukernel_8xn_bs_partial);
...
// // group_def_ukernel!(16, 1, 8, B, B, bb, def_ukernel, asm_8x4_step, asm_8x4_acc, asm_8x4_store, VER1);
// // group_def_ukernel!(16, 1, 8, B, S, bs, def_ukernel, asm_8x4_step, asm_8x4_acc, asm_8x4_store, VER1);
// group_def_ukernel!(16, 1, 8, B, B, M, bb_partial, asm_8x4_step, asm_8x4_acc, asm_8x4_store, VER1);
// group_def_ukernel!(16, 1, 8, B, S, M, bs_partial, asm_8x4_step, asm_8x4_acc, asm_8x4_store, VER1);
