...
unsafe fn kernel_mn<F: UnaryFnC>(
    ...
    if kc_last {
        match hw_cfg.reg_dim {
            RegDim::Avx512f => {
                avx512f::kernel_ss(m, n, k, alpha, beta, a, a_rs, a_cs, b, b_rs, b_cs, c, c_rs, c_cs, hw_cfg.func)
            }
        ...
        match hw_cfg.reg_dim {
            RegDim::Avx512f => {
                avx512f::kernel_ss(m, n, k, alpha, beta, a, a_rs, a_cs, b, b_rs, b_cs, c, c_rs, c_cs, null_fn)
            }
            RegDim::AvxFma => return,
            RegDim::Avx => return,
            RegDim::Sse => return,
