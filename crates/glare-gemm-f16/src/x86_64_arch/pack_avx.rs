...
pub(crate) unsafe fn pack_t<const MR: usize>(a: *const f16, lda: usize, ap: *mut f32) {
...
#[target_feature(enable = "avx,f16c")]
pub(crate) unsafe fn pack_kx24_v1(k: usize, a: *const f16, lda: usize, ap: *mut f32) {
    let k8 = k / 8 * 8;
    let mut k_i = 0;
    let a0 = a;
    let ap0 = ap;
...
#[target_feature(enable = "avx,f16c")]
pub(crate) unsafe fn pack_kx48_v1(k: usize, a: *const f16, lda: usize, ap: *mut f32) {
    let k8 = k / 8 * 8;
    let mut k_i = 0;
    let a0 = a;
    let ap0 = ap;
...
#[target_feature(enable = "avx,f16c")]
pub(crate) unsafe fn pack_kx16_v1(k: usize, a: *const f16, lda: usize, ap: *mut f32) {
    let k8 = k / 8 * 8;
    let mut k_i = 0;
    let a0 = a;
    let ap0 = ap;
...
#[target_feature(enable = "avx,f16c")]
pub(crate) unsafe fn pack_kx4_v1(k: usize, b: *const f16, ldb: usize, bp: *mut f32) {
    let k8 = k / 8 * 8;
...
#[target_feature(enable = "avx,f16c")]
pub(crate) unsafe fn pack_kx8_v1(k: usize, a: *const f16, lda: usize, ap: *mut f32) {
    let k8 = k / 8 * 8;
    let mut k_i = 0;
    let a0 = a;
    let ap0 = ap;
