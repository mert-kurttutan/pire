        ...
        paste! {
            ...
            pub unsafe fn kernel_bb<F: MyFn, const STRIDED: bool>(
                ...
                while m_iter > 0 {
                    ...
                    while n_iter > 0 {
                        let a_pft1_offset = ($MR+(n_iter0-n_iter)*2)*2*k;
        ...
        paste! {
            ...
            pub unsafe fn kernel_bs_v0<F: MyFn, const STRIDED: bool>(
                ...
                while m_iter > 0 {
                    ...
                    let mut c_cur1 = c_cur0;
                    while n_iter > 0 {
                        [<ukernel_$MR x $NR _bs>]::<_, STRIDED>(ap_cur, b_cur, c_cur1, alpha, beta, k, d_arr, ($MR+(n_iter0-n_iter)*2), f);
                        n_iter -= 1;
        ...
        paste! {
            ...
            pub unsafe fn kernel_sb_v0<F: MyFn, const STRIDED: bool>(
                ...
                while m_iter > 0 {
                    ...
                    let mut b_cur = b;
                    let mut c_cur1 = c_cur0;
                    packa_panel_64_same(MR, k, a_cur, a_rs, a_cs, ap_cur, VS);
                    while n_iter > 0 {
                        let a_pft1_offset = ($MR+(n_iter0-n_iter)*2)*4*k;
                ...
                $(
                    if (m_left+VS-1) / VS *VS == $mr_left {
                        packa_panel_64_same(m_left, k, a_cur, a_rs, a_cs, ap_cur, VS);
                        let mut n_iter = n_iter0;
                        let mut b_cur = b;
                        let mut c_cur1 = c_cur0;
                        while n_iter > 0 {
                            [<ukernel_$mr_left x $NR _bb_partial>]::<_, STRIDED>(ap_cur, b_cur, c_cur1, alpha, beta, k, d_arr, m_left, f);
                            n_iter -= 1;
                            b_cur = b_cur.add(NR*k);
                            c_cur1 = c_cur1.add(NR*c_cs);
                        }
