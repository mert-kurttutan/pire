...
// def_ukernel_avx!(2, step_2x4, acc_2x4, store_2x4, 2, 4, B, C, ukernel_bbc);

def_ukernel_avx!(2, step_2x4, acc_2x4, store_2x4, 2, 4, B, P, ukernel_2_bbp);
def_ukernel_avx!(2, step_1x4, acc_1x4, store_1x4, 1, 4, B, P, ukernel_1_bbp);
