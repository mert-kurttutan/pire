...
unsafe fn packa_fn(a: *const i16, ap: *mut i16, m: usize, k: usize, a_rs: usize, a_cs: usize) {
    let mut a_cur = a;
    let mut ap_cur = ap;
    let mr = 1;
    let mut i = 0;
...
unsafe fn packb_fn(b: *const i16, bp: *mut i16, n: usize, k: usize, b_rs: usize, b_cs: usize) {
    let mut b_cur = b;
    let mut bp_cur = bp;
    let nr = 1;
    let mut i = 0;
