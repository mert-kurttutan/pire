...
def_ukernel_int!(2, step_3x8, acc_3x8, store_3x8, 48, 8, B, B, M, ukernel_3_bb_partial);
def_ukernel_int!(2, step_2x12, acc_2x12, store_2x12, 32, 8, B, B, M, ukernel_2_bb_partial);
def_ukernel_int!(2, step_1x12, acc_1x12, store_1x12, 16, 8, B, B, M, ukernel_1_bb_partial);

def_ukernelxn_int!(2, step_3x8, acc_3x8, store_3x8, 48, 8, B, B, C, ukernel_n_bb);

def_ukernelxn_int!(2, step_3x8, acc_3x8, store_3x8, 48, 8, B, B, M, ukernel_3xn_bb_partial);
def_ukernelxn_int!(2, step_2x12, acc_2x12, store_2x12, 32, 8, B, B, M, ukernel_2xn_bb_partial);
def_ukernelxn_int!(2, step_1x12, acc_1x12, store_1x12, 16, 8, B, B, M, ukernel_1xn_bb_partial);
