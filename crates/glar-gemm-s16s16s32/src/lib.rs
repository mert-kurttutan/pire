...
use glar_base::{
    ap_size_int, bp_size_int, get_cache_params, has_i16i32_compute, Array, ArrayMut, GemmCache, GlarPar, HWModel,
...
pub(crate) unsafe fn glar_gemm_s16s16s32_generic<F: MyFn>(
    m: usize,
    n: usize,
    k: usize,
    alpha: f32,
...
pub unsafe fn glar_gemv_s16s16s32(
    m: usize,
    n: usize,
    alpha: f32,
    a: *const TA,
    ...
    glar_gemm_s16s16s32(m, 1, n, alpha, a, a_rs, a_cs, x, 1, incx, beta, y, 1, incy)
}
pub unsafe fn glar_dot_s16s16s32(
    n: usize,
    alpha: f32,
    x: *const TA,
    incx: usize,
    ...
    glar_gemm_s16s16s32(1, 1, n, alpha, x, incx, 1, y, incy, 1, beta, res, 1, 1)
}
    ...
    #[cfg(target_arch = "x86_64")]
    {
        ...
        for p in (0..k).step_by(kc) {
            ...
            for i in (0..m).step_by(mc) {
                ...
                let kc_len_eff = if has_i16i32_compute() {
...
pub unsafe fn packa_i16_with_ref(m: usize, k: usize, a: &[TA], a_rs: usize, a_cs: usize, ap: &mut [TA]) -> Array<TA> {
    ...
    unsafe { packa_i16(m, k, a.as_ptr(), a_rs, a_cs, ap.as_mut_ptr()) }
}
...
pub unsafe fn packb_i16_with_ref(n: usize, k: usize, b: &[TB], b_rs: usize, b_cs: usize, bp: &mut [TB]) -> Array<TB> {
    ...
    unsafe { packb_i16(n, k, b.as_ptr(), b_rs, b_cs, bp.as_mut_ptr()) }
}
