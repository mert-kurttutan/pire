...
impl<F: MyFn> X86_64dispatcher<F> {
    pub(crate) fn from_hw_cfg(hw_config: &HWConfig, mc: usize, nc: usize, kc: usize, f: F) -> Self {
        ...
        let (mr, nr, reg_dim) = if features.avx512f {
            ...
            match hw_config.hw_model {
                HWModel::Broadwell => (8, 6, RegDim::Reg8x6),
                _ => (12, 4, RegDim::Reg12x4),
            }
        } else {
            (8, 4, RegDim::Reg8x4)
        };
    ...
    pub(crate) unsafe fn packa_fn(
        ...
        match self.reg_dim {
            ...
            RegDim::Reg8x6 | RegDim::Reg8x4 => pack_avx::packa_panel_8(m, k, x, rs, cs, y, self.vs),
        }
    }
    ...
    pub(crate) unsafe fn packb_fn(
        ...
        match self.reg_dim {
            ...
            RegDim::Reg8x6 => pack_avx::packb_panel_6(n, k, x, cs, rs, y),
...
unsafe fn kernel<F: MyFn>(
    ...
    if kc_last {
        ...
        match hw_cfg.reg_dim {
            ...
            RegDim::Reg12x4 => {
                avx_fma::kernel_12x4(m, n, k, alpha, beta, c, c_rs, c_cs, ap, bp, null_fn)
            }
            RegDim::Reg8x6 => {
                avx_fma::kernel_8x6(m, n, k, alpha, beta, c, c_rs, c_cs, ap, bp, null_fn)
            }
...
unsafe fn kernel_m<F: MyFn>(
    ...
    if kc_last {
        match hw_cfg.reg_dim {
            RegDim::Reg24x8 => avx512f::kernel_bs(
                m,
                n,
                k,
                alpha,
            ...
            RegDim::Reg12x4 => avx_fma::kernel_12x4_bs(
                m,
                n,
                k,
                alpha,
            ...
            RegDim::Reg8x6 => avx_fma::kernel_8x6_bs(
                m,
                n,
                k,
                alpha,
        ...
        match hw_cfg.reg_dim {
            ...
            RegDim::Reg12x4 => avx_fma::kernel_12x4_bs(
                m, n, k, alpha, beta, b, b_rs, b_cs, c, c_rs, c_cs, ap, null_fn,
            ),
            RegDim::Reg8x6 => avx_fma::kernel_8x6_bs(
                m, n, k, alpha, beta, b, b_rs, b_cs, c, c_rs, c_cs, ap, null_fn,
            ),
...
unsafe fn kernel_n<F: MyFn>(
    ...
    if kc_last {
        match hw_cfg.reg_dim {
            RegDim::Reg24x8 => avx512f::kernel_sb(
                m,
                n,
                k,
                alpha,
            ...
            RegDim::Reg12x4 => avx_fma::kernel_12x4_sb(
                m,
                n,
                k,
                alpha,
            ...
            RegDim::Reg8x6 => avx_fma::kernel_8x6_sb(
                m,
                n,
                k,
                alpha,
        ...
        match hw_cfg.reg_dim {
            RegDim::Reg24x8 => avx512f::kernel_sb(
                m, n, k, alpha, beta, a, a_rs, a_cs, b, c, c_rs, c_cs, ap, null_fn,
            ),
            RegDim::Reg12x4 => avx_fma::kernel_12x4_sb(
                m, n, k, alpha, beta, a, a_rs, a_cs, b, c, c_rs, c_cs, ap, null_fn,
            ),
...
unsafe fn glare_gemv<F: MyFn>(
    ...
    let incy = y.rs();
    match hw_cfg.reg_dim {
        RegDim::Reg12x4 | RegDim::Reg24x8 | RegDim::Reg8x6 => avx_fma::axpy(
            m,
            n,
            alpha,
            a.data_ptr(),
