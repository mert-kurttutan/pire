...
def_kernel_bs!(f64, f64, f64, f64, f64, 12, 4, 12, 8, 4);
def_kernel_bs!(f64, f64, f64, f64, f64, 8, 6, 8, 4);
...
def_kernel_sb_v0!(TA, TB, TC, TA, TC, 1, 12, 4, 12, 8, 4);
def_kernel_sb_v0!(TA, TB, TC, TA, TC, 1, 8, 6, 8, 4);
...
pub(crate) unsafe fn kernel_12x4_sb<F: MyFn>(
    ...
    if c_rs == 1 {
        kernel_12x4_sb_v0::<_, false>(m, n, k, alpha, beta, a, a_rs, a_cs, b, c, c_rs, c_cs, ap_buf, f);
    } else {
        kernel_12x4_sb_v0::<_, true>(m, n, k, alpha, beta, a, a_rs, a_cs, b, c, c_rs, c_cs, ap_buf, f);
    }
}
...
pub(crate) unsafe fn kernel_12x4_bs<F: MyFn>(
    ...
    if c_rs == 1 {
        kernel_12x4_bs_v0::<_, false>(m, n, k, alpha, beta, b, b_rs, b_cs, c, c_rs, c_cs, ap, f);
    } else {
        kernel_12x4_bs_v0::<_, true>(m, n, k, alpha, beta, b, b_rs, b_cs, c, c_rs, c_cs, ap, f);
    }
}
...
pub(crate) unsafe fn kernel_8x6_sb<F: MyFn>(
    ...
    if c_rs == 1 {
        kernel_8x6_sb_v0::<_, false>(m, n, k, alpha, beta, a, a_rs, a_cs, b, c, c_rs, c_cs, ap_buf, f);
    } else {
        kernel_8x6_sb_v0::<_, true>(m, n, k, alpha, beta, a, a_rs, a_cs, b, c, c_rs, c_cs, ap_buf, f);
    }
}
...
pub(crate) unsafe fn kernel_8x6_bs<F: MyFn>(
    ...
    if c_rs == 1 {
        kernel_8x6_bs_v0::<_, false>(m, n, k, alpha, beta, b, b_rs, b_cs, c, c_rs, c_cs, ap, f);
    } else {
        kernel_8x6_bs_v0::<_, true>(m, n, k, alpha, beta, b, b_rs, b_cs, c, c_rs, c_cs, ap, f);
    }
}
