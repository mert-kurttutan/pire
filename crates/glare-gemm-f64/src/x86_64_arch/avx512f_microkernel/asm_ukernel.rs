...
// def_ukernel!(VER3, asm_24x8_step, asm_24x8_acc, asm_24x8_store, 24, 8, B, B, C, 0, 128, 4, ukernel_24x8_bb);
// def_ukernel!(VER2, asm_16x12_step, asm_16x12_acc, asm_16x12_store, 16, 8,, B, B, C, 0, 128, 4, ukernel_16x8_bb);
// def_ukernel!(VER1, asm_8x12_step, asm_8x12_acc, asm_8x12_store, 8, 8, B, B, C, 0, 128, 4, ukernel_8x8_bb);

def_ukernel!(VER3, asm_24x8_step, asm_24x8_acc, asm_24x8_store, 24, 8, B, B, M, 0, 128, 4, ukernel_24x8_bb_partial);
def_ukernel!(VER2, asm_16x12_step, asm_16x12_acc, asm_16x12_store, 16, 8, B, B, M, 0, 128, 4, ukernel_16x8_bb_partial);
def_ukernel!(VER1, asm_8x12_step, asm_8x12_acc, asm_8x12_store, 8, 8, B, B, M, 0, 128, 4, ukernel_8x8_bb_partial);

def_ukernel!(VER3, asm_24x8_step, asm_24x8_acc, asm_24x8_store, 24, 8, B, S, C, 0, 128, 4, ukernel_24x8_bs);

def_ukernel!(VER3, asm_24x8_step, asm_24x8_acc, asm_24x8_store, 24, 8, B, S, M, 0, 128, 4, ukernel_24x8_bs_partial);
def_ukernel!(VER2, asm_16x12_step, asm_16x12_acc, asm_16x12_store, 16, 8, B, S, M, 0, 128, 4, ukernel_16x8_bs_partial);
def_ukernel!(VER1, asm_8x12_step, asm_8x12_acc, asm_8x12_store, 8, 8, B, S, M, 0, 128, 4, ukernel_8x8_bs_partial);


def_ukernelxn!(VER3, asm_24x8_step, asm_24x8_acc, asm_24x8_store, 24, 8, B, B, C, 0, 128, 4, ukernel_24xn_bb);
// def_ukernelxn!(VER2, asm_16x12_step, asm_16x12_acc, asm_16x12_store, 16, 8, B, B, C, 0, 128, 4, ukernel_16xn_bb);
// def_ukernelxn!(VER1, asm_8x12_step, asm_8x12_acc, asm_8x12_store, 8, 8, B, B, C, 0, 128, 4, ukernel_8xn_bb);

def_ukernelxn!(VER3, asm_24x8_step, asm_24x8_acc, asm_24x8_store, 24, 8, B, B, M, 0, 128, 4, ukernel_24xn_bb_partial);
def_ukernelxn!(VER2, asm_16x12_step, asm_16x12_acc, asm_16x12_store, 16, 8, B, B, M, 0, 128, 4, ukernel_16xn_bb_partial);
def_ukernelxn!(VER1, asm_8x12_step, asm_8x12_acc, asm_8x12_store, 8, 8, B, B, M, 0, 128, 4, ukernel_8xn_bb_partial);

def_ukernelxn!(VER3, asm_24x8_step, asm_24x8_acc, asm_24x8_store, 24, 8, B, S, C, 0, 128, 4, ukernel_24xn_bs);

def_ukernelxn!(VER3, asm_24x8_step, asm_24x8_acc, asm_24x8_store, 24, 8, B, S, M, 0, 128, 4, ukernel_24xn_bs_partial);
def_ukernelxn!(VER2, asm_16x12_step, asm_16x12_acc, asm_16x12_store, 16, 8, B, S, M, 0, 128, 4, ukernel_16xn_bs_partial);
def_ukernelxn!(VER1, asm_8x12_step, asm_8x12_acc, asm_8x12_store, 8, 8, B, S, M, 0, 128, 4, ukernel_8xn_bs_partial);


// group_def_ukernel!(24, 1, 7, B, B, C, bb, asm_24x8_step, asm_24x8_acc, asm_24x8_store, VER3);
// group_def_ukernel!(24, 1, 1, B, S, C, bs, asm_24x8_step, asm_24x8_acc, asm_24x8_store, VER3);
// group_def_ukernel!(24, 1, 8, B, B, M, bb_partial, asm_24x8_step, asm_24x8_acc, asm_24x8_store, VER3);
// group_def_ukernel!(24, 1, 8, B, S, M, bs_partial, asm_24x8_step, asm_24x8_acc, asm_24x8_store, VER3);

// // group_def_ukernel!(32, 1, 8, B, B, bb, def_ukernel, asm_16x12_step, asm_16x12_acc, asm_16x12_store, VER2);
// // group_def_ukernel!(32, 1, 8, B, S, bs, def_ukernel, asm_16x12_step, asm_16x12_acc, asm_16x12_store, VER2);
// group_def_ukernel!(32, 1, 8, B, B, M, bb_partial, asm_16x12_step, asm_16x12_acc, asm_16x12_store, VER2);
// group_def_ukernel!(32, 1, 8, B, S, M, bs_partial, asm_16x12_step, asm_16x12_acc, asm_16x12_store, VER2);


// // group_def_ukernel!(16, 1, 8, B, B, bb, def_ukernel, asm_8x12_step, asm_8x12_acc, asm_8x12_store, VER1);
// // group_def_ukernel!(16, 1, 8, B, S, bs, def_ukernel, asm_8x12_step, asm_8x12_acc, asm_8x12_store, VER1);
// group_def_ukernel!(16, 1, 8, B, B, M, bb_partial, asm_8x12_step, asm_8x12_acc, asm_8x12_store, VER1);
// group_def_ukernel!(16, 1, 8, B, S, M, bs_partial, asm_8x12_step, asm_8x12_acc, asm_8x12_store, VER1);


// based on l1 prefetching scheme is from openblas impl for skylax
// see: httpd://github.com/OpenMathLib/OpenBLAS/pull/2300
// this is adapted to our ukernel of 24x8
