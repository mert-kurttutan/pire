...
macro_rules! acc_8x12 {
	($mr:tt, $nr:tt, $layout:tt) => {
		seq!(n in 0..$nr {
			concat!(
				#(
					acc_8x12_seq!($mr, n, $layout), 
				)*
			)
		})
	};
...
macro_rules! store_8x12 {
	($mr:tt, $nr:tt, $layout:tt) => {
		seq!(n in 0..$nr {
			concat!(
				#(
					store_8x12_seq!($mr, n, $layout), 
				)*
			)
		})
	};
...
// def_ukernel!(VER3, step_24x8, acc_24x8, store_24x8, 24, 8, B, B, C, 0, 128, 4, ukernel_24x8_bb);
// def_ukernel!(VER2, step_16x12, acc_16x12, store_16x12, 16, 8,, B, B, C, 0, 128, 4, ukernel_16x8_bb);
// def_ukernel!(VER1, step_8x12, acc_8x12, store_8x12, 8, 8, B, B, C, 0, 128, 4, ukernel_8x8_bb);

def_ukernel!(VER3, step_24x8, acc_24x8, store_24x8, 24, 8, B, B, M, 0, 128, 4, ukernel_24x8_bb_partial);
def_ukernel!(VER2, step_16x12, acc_16x12, store_16x12, 16, 8, B, B, M, 0, 128, 4, ukernel_16x8_bb_partial);
def_ukernel!(VER1, step_8x12, acc_8x12, store_8x12, 8, 8, B, B, M, 0, 128, 4, ukernel_8x8_bb_partial);

def_ukernel!(VER3, step_24x8, acc_24x8, store_24x8, 24, 8, B, S, C, 0, 128, 4, ukernel_24x8_bs);

def_ukernel!(VER3, step_24x8, acc_24x8, store_24x8, 24, 8, B, S, M, 0, 128, 4, ukernel_24x8_bs_partial);
def_ukernel!(VER2, step_16x12, acc_16x12, store_16x12, 16, 8, B, S, M, 0, 128, 4, ukernel_16x8_bs_partial);
def_ukernel!(VER1, step_8x12, acc_8x12, store_8x12, 8, 8, B, S, M, 0, 128, 4, ukernel_8x8_bs_partial);


def_ukernelxn!(VER3, step_24x8, acc_24x8, store_24x8, 24, 8, B, B, C, 0, 128, 4, ukernel_24xn_bb);
// def_ukernelxn!(VER2, step_16x12, acc_16x12, store_16x12, 16, 8, B, B, C, 0, 128, 4, ukernel_16xn_bb);
// def_ukernelxn!(VER1, step_8x12, acc_8x12, store_8x12, 8, 8, B, B, C, 0, 128, 4, ukernel_8xn_bb);

def_ukernelxn!(VER3, step_24x8, acc_24x8, store_24x8, 24, 8, B, B, M, 0, 128, 4, ukernel_24xn_bb_partial);
def_ukernelxn!(VER2, step_16x12, acc_16x12, store_16x12, 16, 8, B, B, M, 0, 128, 4, ukernel_16xn_bb_partial);
def_ukernelxn!(VER1, step_8x12, acc_8x12, store_8x12, 8, 8, B, B, M, 0, 128, 4, ukernel_8xn_bb_partial);

def_ukernelxn!(VER3, step_24x8, acc_24x8, store_24x8, 24, 8, B, S, C, 0, 128, 4, ukernel_24xn_bs);

def_ukernelxn!(VER3, step_24x8, acc_24x8, store_24x8, 24, 8, B, S, M, 0, 128, 4, ukernel_24xn_bs_partial);
def_ukernelxn!(VER2, step_16x12, acc_16x12, store_16x12, 16, 8, B, S, M, 0, 128, 4, ukernel_16xn_bs_partial);
def_ukernelxn!(VER1, step_8x12, acc_8x12, store_8x12, 8, 8, B, S, M, 0, 128, 4, ukernel_8xn_bs_partial);


// group_def_ukernel!(24, 1, 7, B, B, C, bb, step_24x8, acc_24x8, store_24x8, VER3);
// group_def_ukernel!(24, 1, 1, B, S, C, bs, step_24x8, acc_24x8, store_24x8, VER3);
// group_def_ukernel!(24, 1, 8, B, B, M, bb_partial, step_24x8, acc_24x8, store_24x8, VER3);
// group_def_ukernel!(24, 1, 8, B, S, M, bs_partial, step_24x8, acc_24x8, store_24x8, VER3);

// // group_def_ukernel!(32, 1, 8, B, B, bb, def_ukernel, step_16x12, acc_16x12, store_16x12, VER2);
// // group_def_ukernel!(32, 1, 8, B, S, bs, def_ukernel, step_16x12, acc_16x12, store_16x12, VER2);
// group_def_ukernel!(32, 1, 8, B, B, M, bb_partial, step_16x12, acc_16x12, store_16x12, VER2);
// group_def_ukernel!(32, 1, 8, B, S, M, bs_partial, step_16x12, acc_16x12, store_16x12, VER2);


// // group_def_ukernel!(16, 1, 8, B, B, bb, def_ukernel, step_8x12, acc_8x12, store_8x12, VER1);
// // group_def_ukernel!(16, 1, 8, B, S, bs, def_ukernel, step_8x12, acc_8x12, store_8x12, VER1);
// group_def_ukernel!(16, 1, 8, B, B, M, bb_partial, step_8x12, acc_8x12, store_8x12, VER1);
// group_def_ukernel!(16, 1, 8, B, S, M, bs_partial, step_8x12, acc_8x12, store_8x12, VER1);
