...
impl<
A: GemmArray<X=TA,Y=TA>, 
B: GemmArray<X=TB,Y=TB>,
C: GemmOut<X=TC,Y=TC>,
...
impl UnaryOp<TC,TC> for Identity {
    const IS_IDENTITY: bool = true;
    #[inline(always)]
    unsafe fn apply_inplace(_x: *mut TC) {
        
    }

    #[inline(always)]
    unsafe fn map(_x: *const TC, _y: *mut TC) {
...
impl SupM for StridedMatrix<TB>{
    #[target_feature(enable = "avx,fma")]
    unsafe fn kernel_sup_m(
        m: usize, n: usize, k: usize,
        alpha: *const TA,
        beta: *const TC,
        b: StridedMatrix<TB>, b_rs: usize, b_cs: usize,
        c: *mut TC, c_rs: usize, c_cs: usize,
        ap: *const TA,
    ) {
...
impl SupN for StridedMatrix<TA>{
    #[target_feature(enable = "avx,fma")]
    unsafe fn kernel_sup_n(
        m: usize, n: usize, k: usize,
        alpha: *const TA,
        beta: *const TC,
        a: StridedMatrix<TA>, a_rs: usize, a_cs: usize,
        c: *mut TC, c_rs: usize, c_cs: usize,
        bp: *const TB,
    ) {
