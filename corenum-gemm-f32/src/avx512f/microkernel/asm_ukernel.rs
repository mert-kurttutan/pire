 ...
 macro_rules! loadps {
    (48, $layout:tt, $m0:expr, $r1:expr, $r2:expr, $r3:expr) => {
        concat!(
            ...
            loadps_unit!($layout, mem!($m0, "0x40"), $r2),
            loadps_unit!($layout, mem!($m0, "0x80"), $r3),
        )
    };
...
macro_rules! load_b {
	(C, 0, $K:tt, $X:tt, $r:expr) => {
    	concat!(
        	"vbroadcastss ", $K, "*4({bx}),%zmm", $r, "\n",
    	)
	};
	(C, 1, $K:tt, $X:tt, $r:expr) => {
    	concat!(
        	"vbroadcastss ", $K, "*4({bx},{x2},1),%zmm", $r, "\n",
    	)
	};
	(C, 2, $K:tt, $X:tt, $r:expr) => {
    	concat!(
        	"vbroadcastss ", $K, "*4({bx},{x2},2),%zmm", $r, "\n",
    	)
	};
	(C, 3, $K:tt, $X:tt, $r:expr) => {
    	concat!(
        	"vbroadcastss ", $K, "*4({x3}),%zmm", $r, "\n",
    	)
	};
	(C, 4, $K:tt, $X:tt, $r:expr) => {
    	concat!(
        	"vbroadcastss ", $K, "*4({x3},{x2},1),%zmm", $r, "\n",
    	)
	};
...
group_def_ukernel!(48, 1, 8, F, B, B, bb, def_ukernel, asm_48x8_step, asm_48x8_acc, asm_48x8_store, VER48);
group_def_ukernel!(48, 1, 8, F, B, R, br, def_ukernel, asm_48x8_step, asm_48x8_acc, asm_48x8_store, VER48);
group_def_ukernel!(48, 1, 8, F, B, C, bc, def_ukernel, asm_48x8_step, asm_48x8_acc, asm_48x8_store, VER48);
group_def_ukernel!(48, 8, 8, T, B, C, rb_t, def_ukernel, asm_48x8_step, asm_48x8_acc, asm_48x8_store, VER48);
group_def_ukernel!(48, 8, 8, T, B, R, cb_t, def_ukernel, asm_48x8_step, asm_48x8_acc, asm_48x8_store, VER48);
group_def_ukernel!(48, 1, 8, F, B, B, bb_partial, def_ukernel_partial, asm_48x8_step, asm_48x8_acc, asm_48x8_store, VER48);
group_def_ukernel!(48, 1, 8, T, B, C, rb_t_partial, def_ukernel_partial_new, asm_48x8_step, asm_48x8_acc, asm_48x8_store, VER48);
group_def_ukernel!(48, 1, 8, T, B, R, cb_t_partial, def_ukernel_partial_new, asm_48x8_step, asm_48x8_acc, asm_48x8_store, VER48);

group_def_ukernel!(32, 1, 12, F, B, B, bb, def_ukernel, asm_32x12_step, asm_32x12_acc, asm_32x12_store, VER32);
group_def_ukernel!(32, 1, 8, F, B, R, br, def_ukernel, asm_32x12_step, asm_32x12_acc, asm_32x12_store, VER32);
group_def_ukernel!(32, 1, 8, F, B, C, bc, def_ukernel, asm_32x12_step, asm_32x12_acc, asm_32x12_store, VER32);
group_def_ukernel!(32, 1, 12, F, B, B, bb_partial, def_ukernel_partial, asm_32x12_step, asm_32x12_acc, asm_32x12_store, VER32);
group_def_ukernel!(32, 1, 8, T, B, C, rb_t_partial, def_ukernel_partial_new, asm_32x12_step, asm_32x12_acc, asm_32x12_store, VER32);
group_def_ukernel!(32, 1, 8, T, B, R, cb_t_partial, def_ukernel_partial_new, asm_32x12_step, asm_32x12_acc, asm_32x12_store, VER32);

group_def_ukernel!(16, 1, 12, F, B, B, bb, def_ukernel, asm_16x12_step, asm_16x12_acc, asm_16x12_store, VER16);
group_def_ukernel!(16, 1, 8, F, B, R, br, def_ukernel, asm_16x12_step, asm_16x12_acc, asm_16x12_store, VER16);
group_def_ukernel!(16, 1, 8, F, B, C, bc, def_ukernel, asm_16x12_step, asm_16x12_acc, asm_16x12_store, VER16);
group_def_ukernel!(16, 1, 12, F, B, B, bb_partial, def_ukernel_partial, asm_16x12_step, asm_16x12_acc, asm_16x12_store, VER16);
group_def_ukernel!(16, 1, 8, T, B, C, rb_t_partial, def_ukernel_partial_new, asm_16x12_step, asm_16x12_acc, asm_16x12_store, VER16);
group_def_ukernel!(16, 1, 8, T, B, R, cb_t_partial, def_ukernel_partial_new, asm_16x12_step, asm_16x12_acc, asm_16x12_store, VER16);
